...
public class AggiungiBulloneFrame extends JFrame implements WindowListener {
	...
	private void creaFormPanel() {
		...
		gbcForComboBoxMateriale.gridy = 5;
		...
		gbcForSpinnerLunghezza.gridy = 6;
		...
		gbcForSpinnerDiametroVite.gridy = 7;
