...
class PannelloImpiegato extends JPanel {
	...
	private void aggiungiElementiIntestazione() {
		...
		Dimension offsetDimension = new Dimension((int) (this.dim.getWidth() * 3), (int) (this.dim.getHeight() * 3));// per 3 poiche l'intestazione non
																													// presenta i bottoni
																													// quindi devo accupare lo
																													// stesso spazio che occupano i
																													// 3 bottoni di un pannello che
																													// visualizza un impiegato
